...
function Login() {
  ...
  return (
    <main className="w-11/12 max-w-lg mx-auto font-urbanist min-h-screen box-border">
      ...
      <h2 className="text-custom-grey text-xl font-semibold mt-8 mb-4">
      ...
      <div className="w-full flex flex-col justify-center items-center gap-2">
        <button
          onClick={handleLogin}
          className={`bg-custom-blue text-lg text-white font-semibold mt-12 h-14 rounded-2xl w-full ${
      ...
      <h3 className="mt-6 text-center font-semibold text-custom-grey">
        Not a User yet?{" "}
        <Link className="text-custom-blue" href="/signup">
          Sign Up
        </Link>{" "}
        Now
      </h3>
