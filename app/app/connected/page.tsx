  ...
  return (
    <main className="w-11/12 max-w-lg mx-auto font-urbanist min-h-screen box-border">
      ...
      <div className="w-full flex flex-col justify-center items-center mt-4 gap-2">
        <Link
          href="/signup"
          className="bg-custom-blue text-lg text-white font-semibold h-14 rounded-2xl flex justify-center items-center w-[350px]"
        >
          New to teleHealthSol
        </Link>
        <Link
          href="/login"
          className="bg-white text-lg text-custom-blue border flex justify-center items-center border-custom-blue font-semibold h-14 rounded-2xl p-0 w-[350px]"
        >
          Log In
        </Link>
      </div>
